...
import { blogArticles, featuredArticleSlug, getArticle, getArticlesBySlugs } from "@/content/articles"
...
/**
 * Статьи лежат по файлу на статью в src/content/articles/.
 * Здесь только реэкспорт, чтобы старые импорты из "@/site-data" продолжали работать.
 */
export { blogArticles, featuredArticleSlug, getArticle, getArticlesBySlugs }
export {
  formatArticleDate,
  topicLabels,
  topicOrder,
